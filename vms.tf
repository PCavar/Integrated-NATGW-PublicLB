...
resource "azurerm_virtual_machine_extension" "powershell_script_vm1" {
  name                 = "Install-IIS"
  ...
  settings = <<SETTINGS
    {
      "fileUris": ["https://raw.githubusercontent.com/PCavar/Integrated-NATGW-PublicLB/main/install-iis.ps1"],
